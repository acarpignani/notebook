...
2.  Generate a vector that contains 20 random numbers. Replace the 10 central values (i.e. the values in positions 5 to 15) with their corresponding squares. Round the final vector to three decimal places.
